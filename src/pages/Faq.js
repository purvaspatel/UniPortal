  ...
  const faqData = [
    {
      ...
      answer: "Exam cell office is located in C-Block 2nd Floor. Students need to submit a request on PDEU POSS Portal and then collect it between 2-4 pm accordingly."
    },
    {
      id: 2,
